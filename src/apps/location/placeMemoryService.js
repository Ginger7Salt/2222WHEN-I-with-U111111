...
const buildPlaceNoteOfferText = (placeName) => [
  '【可选行为：在小册子里留一句小记录】',
  `你和用户有一本共同的"地点小册子"，用户此刻就在「${placeName}」。你可以悄悄给这个地方留一句记录，用户之后会在小册子里看到。适合记两类东西：`,
  '① 这个地方发生过的一件真正值得记住的小事（比如用户说了一句有趣的话、做了什么）。',
  '② 你对用户在这个地方的一点观察（比如"你总在这里找我聊天，最近似乎心情不太好"）。语气要温柔，用"好像""似乎"这样不下结论的说法；不要诊断，也不要写会让用户觉得被监视、被评判的话。',
  '做法：在这次回复的最后另起一行，写 [PLACE_NOTE: 一句话]。例如：[PLACE_NOTE: 今天在这里说想养一只猫]',
  '规则：',
  '1. 这是很少使用的行为。大多数时候不要用，拿不准就不用。',
  '2. 只记录这次聊天里真实发生的事，或者你从这次聊天里真的感觉到的，不要编造，也不要只是重复地点名字或位置本身。只凭聊天次数，不能下判断。',
